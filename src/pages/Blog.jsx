...
export default function Blog() {
  return (
    <>
      <SEOHead title="Blog" description="Pharmacy career tips, AKTU exam guides, scholarship info, and pharmaceutical industry insights from SCHES experts." />

      <section className="gradient-primary section-padding">
        <div className="container-custom text-center text-white">
          <p className="text-secondary font-bold mb-3">Knowledge Center</p>
          <h1 className="text-4xl md:text-5xl font-black mb-4">SCHES Blog</h1>
